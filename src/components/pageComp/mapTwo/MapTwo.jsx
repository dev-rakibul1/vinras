    ...
    <div className="bg-[url(https://i.ibb.co/2t7SZvB/BG.png)] bg-no-repeat bg-cover bg-center py-24">
      <div className="vinras-container">
        <div className="grid lg:grid-cols-2 grid-cols-1 mb-10">
          <SectionTitleLeft
            title=" Why Choose Us "
            titleHeading="Client Choose Wisely"
          />

          <div className="grid md:grid-cols-2 grid-cols-1">
            <div className="flex items-center gap-7">
              <div className="">
                <img src="/images/icon-31.png" alt="" srcset="" />
              </div>
              <div className="">
            ...
            <div className="flex items-center gap-7">
              <div className="">
                <img src="/images/icon-32.png" alt="" srcset="" />
              </div>
              <div className="">
                  ...
                  <div className="whyChoose-card shadow p-9 transition-all duration-700">
                    <div className="w-[75px] h-[75px] pt-2 pl-2  rounded-md bg-[#fee4dd]">
                      <div className="imgCard h-[75px] w-[75px] bg-primary rounded-md rounded-br-3xl flex items-center justify-center">
                        ...
                        <img
                          className="img2"
                          src="../images/map/iconWhite-1.png"
                          alt=""
                          srcset=""
                        />
                      </div>
                  ...
                  <div className="whyChoose-card shadow p-9 transition-all duration-700">
                    <div className="w-[75px] h-[75px] pt-2 pl-2  rounded-md bg-[#fee4dd]">
                      <div className="imgCard h-[75px] w-[75px] bg-primary rounded-md rounded-br-3xl flex items-center justify-center">
                        ...
                        <img
                          className="img2"
                          src="../images/map/iconWhite-2.png"
                          alt=""
                          srcset=""
                        />
                      </div>
                  ...
                  <div className="whyChoose-card shadow p-9 transition-all duration-700">
                    <div className="w-[75px] h-[75px] pt-2 pl-2  rounded-md bg-[#fee4dd]">
                      <div className="imgCard h-[75px] w-[75px] bg-primary rounded-md rounded-br-3xl flex items-center justify-center">
                        <img
                          className="img1"
                          src="../images/map/icon-3.png"
                          alt=""
                          srcset=""
                        />
                        <img
                          className="img2"
                          src="../images/map/iconWhite-3.png"
                          alt=""
                          srcset=""
                        />
                      </div>
                  ...
                  <div className="whyChoose-card shadow p-9 transition-all duration-700">
                    <div className="w-[75px] h-[75px] pt-2 pl-2  rounded-md bg-[#fee4dd]">
                      <div className="imgCard h-[75px] w-[75px] bg-primary rounded-md rounded-br-3xl flex items-center justify-center">
                        <img
                          className="img1"
                          src="../images/map/icon-4.png"
                          alt=""
                          srcset=""
                        />
                        <img
                          className="img2"
                          src="../images/map/iconWhite-4.png"
                          alt=""
                          srcset=""
                        />
                      </div>
