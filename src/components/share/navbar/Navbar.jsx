                ...
                <div className="flex items-center justify-between navbar-social-icons">
                  <ul
                    className={`flex items-center justify-between ${
                      location.pathname !== "/" ? "social-extra-color" : ""
                    }`}
                  >
                    ...
                    <li className="nav-items relative">
                      ...
                      >
                        <ul className="triangle-top">
                          ...
                          <li className="nav-items">
                            <Link className="nav-links" to="/servicePage">
                              Services
                            </Link>
                          </li>

                          <li className="nav-items">
                            <Link className="nav-links" to="/servicePage2">
                              Services 2
                            </Link>
                          </li>

                          <li className="nav-items">
                            <Link className="nav-links" to="/serviceDetails">
                              Services Details
                            </Link>
                          </li>

                          <li className="nav-items">
                            <Link className="nav-links" to="/serviceDetails2">
                              Services Details 2
                            </Link>
                          </li>
                          ...
                          <li className="nav-items">
                            <Link className="nav-links" to="/ourPortfolio">
                              Portfolio details
                            </Link>
                          </li>
                          <li className="nav-items">
                            <Link className="nav-links" to="/portfolioDetails">
                              Portfolio details 2
                            </Link>
                          </li>
                        </ul>
                    ...
                    <li className="nav-items relative">
                      ...
                      >
                        <ul className="triangle-top">
                          ...
                          <li className="nav-items">
                            <Link className="nav-links" to="/member">
                              Team
                            </Link>
                          </li>

                          <li className="nav-items">
                            <Link className="nav-links" to="/teamDetails">
                              Team details
                            </Link>
                          </li>

                          <li className="nav-items">
                            <Link className="nav-links" to="/faq-2">
                              FAQ
                            </Link>
                          </li>
                        </ul>
