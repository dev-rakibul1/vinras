...
const Faq2 = () => {
  return (
    <div>
      <div>
        <TopBanner routeName="Faq" path1="Home" path2="faq" />
      </div>

      <div className="vinras-container my-24">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 items-center">
          <div
            tabIndex={0}
            className="collapse collapse-plus px-6 py-4 border border-none bg-white rounded-box shadow-lg"
          >
          ...
          >
            <div className="collapse-title text-[20px] font-medium">
              2. Write The Changelog For Theme ?
            </div>
            <div className="collapse-content">
              <p>
                There are many variations of passages the majority have suffered
          ...
          >
            <div className="collapse-title text-[20px] font-medium">
              3. We help to achieve mutual goals
            </div>
            <div className="collapse-content">
              <p>
                There are many variations of passages the majority have suffered
          ...
          >
            <div className="collapse-title text-[20px] font-medium">
              4. What happend to my design code
            </div>
            <div className="collapse-content">
              <p>
                There are many variations of passages the majority have suffered
          ...
          >
            <div className="collapse-title text-[20px] font-medium">
              5. Benefit Of Digital Marketing?
            </div>
            <div className="collapse-content">
              <p>
                There are many variations of passages the majority have suffered
